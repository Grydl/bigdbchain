...
public class BigchainDBJavaDriverUsageExample {
    ...
    public static void main(String args[]) throws Exception {
        ...
        metaData.setMetaData("total", "100");
        ...
        transferMetadata.setMetaData("Transsfer ", "amount");
        ...
        examples.doTransfer(txId, transferMetadata, keys,keys2);
     ...
     */
    public void doTransfer(String txId, MetaData metaData, KeyPair keysSender, KeyPair keysReceiver) throws Exception {
        ...
        try {
            ...
            Transaction transaction = BigchainDbTransactionBuilder
                    ...
                    .addOutput(String.valueOf(5), (EdDSAPublicKey) keysSender.getPublic())
